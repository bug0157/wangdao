...
int main(){
    ...
    WFHttpTask * httpTask = WFTaskFactory::create_http_task("http://121.4.35.82:80", 0, 0, callback);
    protocol::HttpRequest *req = httpTask->get_req();
